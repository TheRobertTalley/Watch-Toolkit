...
bool Settings::createDefaultSettings(fs::FS &fs, bool spec, uint8_t index, String typeStr, String name) {
  ...
  if (!spec) {
    ...
    jsonBuffer["Settings"][2]["name"] = "EnableLED";
    ...
    jsonBuffer["Settings"][3]["name"] = "ClientSSID";
    jsonBuffer["Settings"][3]["type"] = "String";
    jsonBuffer["Settings"][3]["value"] = "";
    jsonBuffer["Settings"][3]["range"]["min"] = "";
    jsonBuffer["Settings"][3]["range"]["max"] = "";

    jsonBuffer["Settings"][4]["name"] = "ClientPW";

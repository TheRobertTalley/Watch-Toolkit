...
SegmentedDisplayMetrics getSegmentedDisplayMetrics(OLEDDisplay *display)
{
    static bool metricsInitialized = false;
    static SegmentedDisplayMetrics metrics = {0.75f, SEGMENT_WIDTH * 0.75f, SEGMENT_HEIGHT * 0.75f};
    ...
    if (!metricsInitialized) {
        ...
        metrics.scale = scale;
        metrics.segmentWidth = segmentWidth;
        metrics.segmentHeight = segmentHeight;
...
void drawDigitalClockFrame(OLEDDisplay *display, OLEDDisplayUiState *state, int16_t x, int16_t y)
{
    ...
    SegmentedDisplayMetrics metrics = getSegmentedDisplayMetrics(display);
    float scale = metrics.scale;
    float segmentWidth = metrics.segmentWidth;
    float segmentHeight = metrics.segmentHeight;
